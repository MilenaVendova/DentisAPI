...
{
    public class tbShadeRow
    {
        public int ShadeID { get; set; }
        public string? Shade { get; set; }
        public void SetDataFromSQL(SqlDataReader dReader)
        {
            this.ShadeID = (int)dReader["ShadeID"];
            this.Shade = (string)dReader["Shade"];
        }
        public object GetData(string Name)
        {
            return Name switch
            {
                ...
                "Shade" => (this.Shade != null) ? this.Shade : DBNull.Value,
                _ => DBNull.Value,
            };
        }
    }
    public class tbShade : List<tbShadeRow>
    {
        private readonly MyConnection _Connection;
        public tbShade(MyConnection mc) : base()
        {
            _Connection = mc;
        }
        ...
        private SqlCommand SelectCommand
        {
            get
            {
                if (_SelectCommand is null)
                {
                    ...
                    _SelectCommand.CommandText = "sp_tbShade_S";
        ...
        private SqlCommand InsertCommand
        {
            get
            {
                if (_InsertCommand is null)
                {
                    ...
                    _InsertCommand.CommandText = "DECLARE @RETURN_VALUE INT; exec @RETURN_VALUE = sp_tbShade_I  @Shade; SELECT ShadeID , Shade FROM tbShade WHERE ShadeID = @RETURN_VALUE";
                    _InsertCommand.CommandType = CommandType.Text;
                    _InsertCommand.Parameters.Add(new SqlParameter("@Shade", SqlDbType.VarChar, 0, ParameterDirection.Input, 0, 0, "Shade", DataRowVersion.Current, false, null, "", "", ""));
                }
                return _InsertCommand;
            }
        }
        public async Task<tbShadeRow> Insert(tbShadeRow drCurrent, CancellationToken ct)
        {
            ConnectionState cs = _Connection.cnn.State;
            try
            {
        ...
        private SqlCommand UpdateCommand
        {
            get
            {
                if (_UpdateCommand is null)
                {
                    ...
                    _UpdateCommand.CommandText = "exec sp_tbShade_U @ShadeID, @Shade, @Original_Shade; SELECT ShadeID , Shade FROM tbShade WHERE ShadeID = @ShadeID";
                    _UpdateCommand.CommandType = CommandType.Text;
                    _UpdateCommand.Parameters.Add(new SqlParameter("@Shade", SqlDbType.VarChar, 0, ParameterDirection.Input, 0, 0, "Shade", DataRowVersion.Current, false, null, "", "", ""));
                    ...
                    _UpdateCommand.Parameters.Add(new SqlParameter("@Original_Shade", SqlDbType.VarChar, 0, ParameterDirection.Input, 0, 0, "Shade", DataRowVersion.Original, false, null, "", "", ""));
                    _UpdateCommand.Parameters.Add(new SqlParameter("@ShadeID", SqlDbType.Int, 4, ParameterDirection.Input, 0, 0, "ShadeID", DataRowVersion.Current, false, null, "", "", ""));
                }
                return _UpdateCommand;
            }
        }
        public async Task<tbShadeRow> Update(tbShadeRow drOriginal, tbShadeRow drCurrent, CancellationToken ct)
        {
            ConnectionState cs = _Connection.cnn.State;
            try
            {
        ...
        private SqlCommand DeleteCommand
        {
            get
            {
                if (_DeleteCommand is null)
                {
                    ...
                    _DeleteCommand.CommandText = "exec sp_tbShade_D @Original_ShadeID";
                    ...
                    _DeleteCommand.Parameters.Add(new SqlParameter("@Original_Shade", SqlDbType.VarChar, 0, ParameterDirection.Input, 0, 0, "Shade", DataRowVersion.Original, false, null, "", "", ""));
                }
                return _DeleteCommand;
            }
        }
        public async Task<int> Delete(tbShadeRow drOriginal, CancellationToken ct)
        {
            ConnectionState cs = _Connection.cnn.State;
            try
            {
        ...
        private static void SetCommandParameterValue(SqlCommand cmd, tbShadeRow? drOriginal, tbShadeRow? drCurrent)
        {
