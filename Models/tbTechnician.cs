...
namespace DentisHelperAPI.Models
{
    public class tbTechnicianRow
    {
        ...
        {
            this.TechnicianID = (int)dReader["TechnicianID"];
    ...
    public class tbTechnician : List<tbTechnicianRow>
    {
        private readonly MyConnection _Connection;
        public tbTechnician(MyConnection mc) : base()
        {
            _Connection = mc;
        }
        ...
        private SqlCommand SelectCommand
        {
            get
            {
                if (_SelectCommand is null)
                {
                    ...
                    _SelectCommand.CommandText = "sp_tbTechnician_S";
        ...
        public async Task<int> Fill(CancellationToken ct)
        {
            ...
            try
            {
                ...
                {
                    tbTechnicianRow dr = new tbTechnicianRow();
        ...
        private SqlCommand InsertCommand
        {
            get
            {
                if (_InsertCommand is null)
                {
                    ...
                    _InsertCommand.CommandText = "DECLARE @RETURN_VALUE INT; exec @RETURN_VALUE = sp_tbTechnician_I  @Name, @NickName, @Phone, @Email; SELECT TechnicianID , Name , NickName , Phone , Email FROM tbTechnician WHERE TechnicianID = @RETURN_VALUE";
        ...
        public async Task<tbTechnicianRow> Insert(tbTechnicianRow drCurrent, CancellationToken ct)
        {
            ConnectionState cs = _Connection.cnn.State;
            try
            {
        ...
        private SqlCommand UpdateCommand
        {
            get
            {
                if (_UpdateCommand is null)
                {
                    ...
                    _UpdateCommand.CommandText = "exec sp_tbTechnician_U @TechnicianID, @Name, @Original_Name, @NickName, @Original_NickName, @Phone, @Original_Phone, @Email, @Original_Email; SELECT TechnicianID , Name , NickName , Phone , Email FROM tbTechnician WHERE TechnicianID = @TechnicianID";
                    ...
                    _UpdateCommand.Parameters.Add(new SqlParameter("@TechnicianID", SqlDbType.Int, 4, ParameterDirection.Input, 0, 0, "TechnicianID", DataRowVersion.Current, false, null, "", "", ""));
                }
                return _UpdateCommand;
            }
        }
        public async Task<tbTechnicianRow> Update(tbTechnicianRow drOriginal, tbTechnicianRow drCurrent, CancellationToken ct)
        {
            ConnectionState cs = _Connection.cnn.State;
            try
            {
        ...
        private SqlCommand DeleteCommand
        {
            get
            {
                if (_DeleteCommand is null)
                {
                    ...
                    _DeleteCommand.CommandText = "exec sp_tbTechnician_D @Original_TechnicianID";
        ...
        public async Task<int> Delete(tbTechnicianRow drOriginal, CancellationToken ct)
        {
            ConnectionState cs = _Connection.cnn.State;
            try
            {
        ...
        private static void SetCommandParameterValue(SqlCommand cmd, tbTechnicianRow? drOriginal, tbTechnicianRow? drCurrent)
        {
